...
''' Félix LADISLAS, 01/10/22
    DM1, jeu de l'allumette, version 1.1
'''
...
def jeuAllumettes(n):
    ...
    while True:                  # "while true loop" qui répète les manches tant que le programme n'a pas désigné de vainqueur.
        ...
        if initiative == 0:
            ...
            if r == 1 or r == 2 or r == 3:   # On vérifie que le joueur prend bien un nombre correct d'allumette. Sinon on passe son tour.
                nbAllumettes = nbAllumettes - r
            else:
                print(f"\nIl ne faut pas tricher !!!! Il est impossible de prendre {r} allumettes.\n")
